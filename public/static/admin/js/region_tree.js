    ...
    $('img[ds_type="flex"]').click(function(){
        ...
        if(status == 'open')
        {
			...
			str += "</td>";
                        ...
                        str += "</td>";
                        str += "<td><span><a href='"+ADMINSITEURL+"/Region/edit/area_id/" + res[i].area_id + ".html'>编辑</a>  | <a href='javascript:if(confirm(\"确认删除?\"))window.location=\""+ADMINSITEURL+"/Region/drop/area_id/" + res[i].area_id + ".html\";'>删除</a> | <a href='"+ADMINSITEURL+"/Region/add/area_id/" + res[i].area_id + ".html'>添加子分类</a> </span></td></tr>";

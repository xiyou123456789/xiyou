...
class Sellergoodsclass extends BaseSeller
{
    ...
    public function goods_class_save()
    {
        ...
        if (input('post.type') =='edit') {
            ...
            if ($state) {
                ds_show_dialog(lang('ds_common_save_succ'), url('Sellergoodsclass/index'), 'succ', !(input('param.inajax')) ? '' : 'CUR_DIALOG.close();');
            }
            else {
    ...
    public function drop_goods_class()
    {
        ...
        if ($drop_state) {
            ds_show_dialog(lang('ds_common_del_succ'), url('Sellergoodsclass/index'), 'succ');
        }
        else {

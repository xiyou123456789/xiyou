        ...
        if (!request()->isPost()) {
            ...
            if (config('captcha_status_login') == 1 && !captcha_check(input('post.captcha_normal'))) {
                if($inajax==1){
                    ...
                    $this->error(lang('image_verification_code_error'),url('Login/login'));
                }
            }
            $data = array(
            ...
            if ($member_info) {
                ...
                if ($inajax == 1) {
                    ...
                    if ('' != input('param.ref_url')) {
                        $this->success(lang('login_index_login_success'), input('param.ref_url'));
                    }else{
                ...
                if($inajax==1){
                    ds_show_dialog(lang('login_index_login_fail'), '', 'error');
                }else{
                    $this->error(lang('login_index_login_fail'),'Login/login');
                }
            }
        }
    }

...
class Sellerinviter extends BaseSeller {
    ...
    public function goods_add() {
        ...
        if (!request()->isPost()) {
            ...
            if ($result) {
                ...
                ds_show_dialog(lang('goods_add_success'), url('Sellerinviter/goods_list'), 'succ', '', 3);
            } else {
    ...
    public function goods_edit() {
        ...
        if (!request()->isPost()) {
            ...
            if ($result) {
                ...
                ds_show_dialog(lang('goods_edit_success'), url('Sellerinviter/goods_list'), 'succ', '', 3);
            } else {
    ...
    public function goods_del(){
        ...
        if ($result) {
                ...
                ds_show_dialog(lang('goods_del_success'), url('Sellerinviter/goods_list'), 'succ', '', 3);
            } else {

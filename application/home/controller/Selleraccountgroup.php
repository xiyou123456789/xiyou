...
class Selleraccountgroup extends BaseSeller {
    ...
    public function group_save() {
        ...
        if (empty($group_id)) {
            ...
            if($result){
                ds_show_dialog(lang('add_success'), url('Selleraccountgroup/group_list'), 'succ');
            }else{
                ds_show_dialog(lang('add_failure'), url('Selleraccountgroup/group_list'), 'error');
            }
            ...
            if($result){
                ds_show_dialog(lang('edit_success'), url('Selleraccountgroup/group_list'), 'succ');
            }else{
                ds_show_dialog(lang('edit_failure'), url('Selleraccountgroup/group_list'), 'error');
            }

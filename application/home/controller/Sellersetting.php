...
class Sellersetting extends BaseSeller {
        ...
        if (request()->isPost()) {
            ...
            if (!empty(input('post.store_name'))) {
                ...
                if (!empty($store) && ($store_id != $store['store_id'])) {
                    ds_show_dialog(lang('please_change_another_name'), 'reload', 'error');
                    return;
                }
    ...
    public function store_mobile() {
        ...
        if (request()->isPost()) {
            ...
            ds_show_dialog(lang('save_success'), url('Sellersetting/store_mobile'), 'succ');
        }
    ...
    public function map() {
        ...
        if (request()->isPost()) {
            ...
            ds_show_dialog(lang('save_success'), url('Sellersetting/map'), 'succ');
        }
        $this->assign('store_info', $store_info);

<?php
$lang['voucher_unavailable']    = 'The voucher function has not been turned on';
$lang['voucher_applystate_new']    = 'To audit';
$lang['voucher_applystate_verify']    = 'The approved';
$lang['voucher_applystate_cancel']    = 'Has been cancelled';
$lang['voucher_quotastate_activity']	= 'Normal';
$lang['voucher_quotastate_cancel']    = 'Cancel';
$lang['voucher_quotastate_expire']    = 'The end of the';
$lang['voucher_templatestate_usable']	= 'Effective';
$lang['voucher_templatestate_disabled']= 'Failure';
$lang['voucher_quotalist']= 'The package list';
$lang['voucher_applyquota']= 'Application package';
$lang['voucher_applyadd']= 'Purchase plan';
$lang['voucher_templateadd']= 'New vouchers';
$lang['voucher_templateedit']= "Editor's voucher";
...
$lang['voucher_apply_succ']= 'The package application is successful. Please wait for review';
 ...
 * 套餐
 */
$lang['voucher_quota_startdate']    	= 'The start time';
$lang['voucher_quota_enddate']    		= 'The end of time';
...
$lang['voucher_template_noresidual']		= "The activity in the current package is full %s activity information, can not publish the activity again";
...
$lang['voucher_template_title_error'] 		= "The template name cannot be empty and cannot be greater than 50 characters";
$lang['voucher_template_total_error'] 		= "The available quantity cannot be empty and must be an integer";
...
$lang['voucher_template_describe_error'] 	= "The template description cannot be empty and cannot be greater than 255 characters";
$lang['voucher_template_title']			= 'Voucher name';
$lang['voucher_template_enddate']		= 'The period of validity';
$lang['voucher_template_enddate_tip']		= 'The period of validity shall be within the period of validity of the package, and the package in use shall be valid for';
...
$lang['voucher_template_image_tip']		= 'The picture will be displayed in the voucher module in the center of points, click save after uploading, and the recommended size is160*160px。';
$lang['voucher_template_list_tip1'] = "1、After the voucher is set by hand, the user will not be able to get the voucher, but the voucher already received can still be used";
$lang['voucher_template_list_tip2'] = "2、Voucher templates and issued vouchers expire automatically after expiration";
$lang['voucher_template_backlist'] 	= "Returns a list of";
...
$lang['voucher_voucher_price'] = "The amount of";
$lang['voucher_voucher_storename'] = "Apply to the store";
$lang['voucher_voucher_indate'] = "The period of validity";
$lang['voucher_voucher_usecondition'] = "Conditions of use";
$lang['voucher_voucher_usecondition_desc'] = "Orders with";
$lang['voucher_voucher_vieworder'] = "To view the order";
$lang['voucher_voucher_readytouse'] = "Use immediately";
$lang['voucher_voucher_code'] = "Coding";

$lang['voucher_code'] = "Voucher code";
$lang['voucher_use'] = "Use";
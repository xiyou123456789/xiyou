...
$lang['member_order_time']		= 'Place the order of time';
$lang['member_show_order_send_time']	= 'Delivery time';
...
$lang['refund_order_ordersn']		= 'The order no.';
...
$lang['return_number']	= 'The return of the';
...
$lang['return_buyer_message']	= 'Return reason';

$lang['order_sn']		= 'Order';
$lang['order_max_day'] = 'More than';
$lang['order_max_day_cancel'] = 'The system will cancel the order automatically if payment is not made.';
...
//delay
$lang['receiving_prompt_message'] = 'The seller chooses the goods that have not been delivered. Please contact the logistics department for confirmation. The time will be rescheduled after the delivery.';

//index
$lang['platform_confirmation'] = 'Platform to confirm';
$lang['none'] = 'There is no';
$lang['return'] = 'Return of the goods';
$lang['delay'] = 'Time delay';
$lang['delay_time'] = 'Delay time';

//ship
$lang['fill_return_shipping_information'] = 'Please fill in the return shipping information';
$lang['logistics_company'] = 'Logistics company';
$lang['logistics_order_number'] = 'Logistics single number';
$lang['delivery'] = 'The delivery';
$lang['notice_delivery1'] = 'After the day, when the merchant chooses not to receive, the delay time operation shall be performed;';
$lang['notice_delivery2'] = 'If more than';
$lang['notice_delivery3'] = 'The day does not deal with according to discard the goods processing, directly confirms the refund by the administrator.';
$lang['return_list'] = 'Returns a list of';
$lang['fill_logistics_form_number'] = 'Please fill in the logistics number';

//view
$lang['refund_service'] = 'Refund service';
$lang['prompt'] = 'Prompt';
$lang['notice_application_refund1'] = '1. If the merchant refuses to refund or return the goods after submitting the application, the merchant can submit the application again or select <em> "commodity complaint" </em> and request the customer service staff to intervene.';
$lang['notice_application_refund2'] = '2. Successful completion of refund/return;After verification, the refund amount will be returned to your balance account in the form of <em> "pre-deposit" </em> (the top-up card part can only be returned to the balance of the top-up card).';
$lang['buyer_application_return'] = 'Application for return';
$lang['seller_processing_return_application'] = 'Merchants process applications for returns';
$lang['buyer_returns_merchant'] = 'Buyers return goods to merchants';
$lang['confirm_receipt'] = 'Confirm receipt of goods, platform audit';
$lang['my_return_refund_application'] = 'My refund application for returns';
$lang['return_refund_number'] = 'Refund number';
$lang['refund_reason'] = 'Refund reasons';
$lang['refund_amount'] = 'Refund amount';
$lang['refund_instructions_returns'] = 'Refund instructions';
$lang['proof_uploaded'] = 'Credentials to upload';
$lang['merchant_return_refund_processing'] = 'Business return refund processing';
$lang['my_return_shipping_information'] = 'My return shipping information';
$lang['logistics_information'] = 'Logistics information';
$lang['refund_check_mall'] = 'Refund check';
